...
#[cfg(target_os = "windows")]
fn Ok(vec![CaptureSource { id: "desktop".to_string(), name: "Desktop (Full Screen)".to_string(), source_type: "screen".to_string(), width: None, height: None }]) -> Result<Vec<CaptureSource>, String> {
