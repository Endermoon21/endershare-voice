...
import { VoiceChannelSection, useLiveKitContext } from '../../../features/voice';
    ...
    <PageNav>
      ...
      <PageNavContent scrollRef={scrollRef}>
        <Box direction="Column" gap="300">
          ...
          <NavCategory>
            <NavItem variant="Background" radii="400" aria-selected={!showVoiceView && lobbySelected}>
              <NavLink to={getSpaceLobbyPath(getCanonicalAliasOrRoomId(mx, space.roomId))} onClick={() => setShowVoiceView(false)}>
                <NavItemContent>
            ...
            <NavItem variant="Background" radii="400" aria-selected={!showVoiceView && searchSelected}>
              <NavLink to={getSpaceSearchPath(getCanonicalAliasOrRoomId(mx, space.roomId))} onClick={() => setShowVoiceView(false)}>
                <NavItemContent>
                  <Box as="span" grow="Yes" alignItems="Center" gap="200">
                    <Avatar size="200" radii="400">
            ...
            {virtualizer.getVirtualItems().map((vItem) => {
              ...
              return (
                <VirtualTile virtualItem={vItem} key={vItem.index} ref={virtualizer.measureElement}>
                  <RoomNavItem
                    room={room}
                    selected={!showVoiceView && selectedRoomId === roomId}
