...
import { LiveKitProvider, GameStreamProvider } from "../../features/voice";
            ...
            {(serverConfigs) => (
              <CapabilitiesProvider value={serverConfigs.capabilities ?? {}}>
                <MediaConfigProvider value={serverConfigs.mediaConfig ?? {}}>
                  <AuthMetadataProvider value={serverConfigs.authMetadata}><LiveKitProvider><GameStreamProvider>
                    {children}
                  </GameStreamProvider></LiveKitProvider></AuthMetadataProvider>
                </MediaConfigProvider>
