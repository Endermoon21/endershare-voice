...
function VoiceIcon({ connected }: { connected?: boolean }) {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className={classNames(css.ChannelIcon, css.ChannelIconVoice, {
        [css.ChannelIconVoiceConnected]: connected,
      })}
    >
...
function TextChannelIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" className={css.ChannelIcon}>
      <path
        fill="currentColor"
